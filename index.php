  ...
  <div id="main-content" class="container">
    ...
    <div id="home-tiles" class="row">
       <div class="col-md-4 col-sm-6 col-xs-12">
        <a href="login.php" onclick="alertfn()"><div id="menu-tile"><span>Executive</span></div></a>
      </div>

      <div class="col-md-4 col-sm-6 col-xs-12">
        <a href="login.php" onclick="alertfn()"><div id="specials-tile"><span>Members</span></div></a>
      </div>
...
<script>
  function alertfn() {
    alert("To see information you have to login first.")
  }
</script>
